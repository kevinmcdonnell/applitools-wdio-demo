...
var _eyes = require("@wdio/eyes.webdriverio");
...
class ApplitoolsService {
  ...
  beforeSession(config) {
    ...
    const url = process.env.APPLITOOLS_SERVER_URL || config.applitoolsServerUrl;
  ...
  before() {
    ...
    global.browser.addCommand('takeSnapshot', title => {
      ...
      return this.eyes.check(title, _eyes.Target.window());
    });
  }
